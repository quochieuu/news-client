    ...
    return (
        <>
            <header className="header text-center">	    
                <h1 className="blog-name pt-lg-4 mb-0"><Link to="/">Hieu Dev Blog</Link></h1>
                ...
                <nav className="navbar navbar-expand-lg navbar-dark" >
                    ...
                    <div id="navigation" className="collapse navbar-collapse flex-column" >
                        <div className="profile-section pt-3 pt-lg-0">
                            <img className="profile-image mb-3 rounded-circle mx-auto" src={authorAvatar} alt="" />			
                            <div className="bio mb-3">Hi, my name is Hieu Ho. Briefly introduce yourself here. You can also provide a link to the about page.<br/><Link to="/">Find out more about me</Link></div>
                        ...
                        <div className="my-2 my-md-3">
                            <Link className="btn btn-primary" to="/" target="_blank">Get in Touch</Link>
                        </div>
                    </div>
                </nav>
            </header>
